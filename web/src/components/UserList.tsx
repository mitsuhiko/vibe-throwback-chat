...
export function UserList() {
  ...
  const canKickUser = (user: ChannelUser) => {
    ...
    const currentChannelUser = users().find(
      (u) => u.id.toString() === current.id,
    );
              ...
              {(user) => (
                ...
                >
                  ...
                  <div class="flex-shrink-0">
                    <div class="relative">
                      <div
                        class={`w-8 h-8 ${getUserStatusColor(user)} rounded-full flex items-center justify-center`}
                      >
        ...
        <div class="p-3 border-t border-gray-700 bg-gray-800">
          <div class="text-xs text-gray-400">
            ...
            <Show when={getters.getCurrentChannelData()?.topic}>
              <div
                class="mt-1 truncate"
                title={getters.getCurrentChannelData()?.topic}
              >
